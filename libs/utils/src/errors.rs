...
/// convenience function to create a GraphQL error with predictable extension props
...
/// convenience function to create a GraphQL error from an existing error, intended to be used with `.map_err()`
